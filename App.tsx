/*
App.tsx = primeiro esqueleto de um app React Native; função que retorna interface do app
*/
...
// Importando a modelagem TypeScript que criamos 
...
export default function App() {
  //Dados base (simulando o que tinhamos no backend)
  ...
  //funções pra manipular consulta
  function confirmarConsulta() { // praticamente igual ao typescript
    setConsulta({
      ...consulta,
      status: "confirmada",
    });
